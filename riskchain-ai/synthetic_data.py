...
def _random_claim(start: datetime, end: datetime, fraud_label: int, mild: bool = False, ring_entities=None, amount: int = None):
    ...
    return {
        ...
        "lawyer_name": ring_entities.get("lawyer_name") if ring_entities else random.choice(["Smith & Assoc", "Davis Law", "Chen Legal Group", "Rodriguez & Assoc", "Silverstone Law", None]),
        "medical_provider_name": ring_entities.get("medical_provider_name") if ring_entities else random.choice(["WellCare Clinic", "Dr. Garcia", "Dr. Patel", "Dr. Chen", "Dr. Alvarez", "WellCare East", None]),
